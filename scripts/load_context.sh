...
echo ""
echo "================================================================"
echo "  Untuk info lengkap:"
echo "  cat /app/ENTITY_REGISTRY.md       ← SSOT semua entitas"
echo "  cat /app/CODEBASE_MAP.md          ← semua files & endpoints"
echo "  cat /app/memory/SESSION_HANDOFF.md ← state session terakhir"
echo "  cat /app/plan.md                  ← task yang sedang dikerjakan"
echo "================================================================"
echo ""
