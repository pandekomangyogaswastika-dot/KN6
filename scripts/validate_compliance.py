...
def check_entity_registry_sync():
    ...
    known_collections = {
        ...
        "user_onboarding",
        # Discovery module (E-Questionnaire) — canonical, registered in ENTITY_REGISTRY.md
        "discovery_sessions", "discovery_answers", "discovery_attachments",
...
def check_naming_consistency():
    ...
    valid_prefixes = ["inventory_", "warehouse_", "sales_", "finance_", "hr_", "audit_", "wms_", "cycle_", "discovery_"]
    for coll in all_collections:
        if coll in ["users", "sessions", "products", "customers", "warehouses", "uoms", 
                    ...
                    "business_entities", "notifications",
                    "system_settings", "payment_terms", "approval_rules"]:
            continue  # Known valid without prefix (config/master domain)
